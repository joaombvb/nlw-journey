...
const criarItemDeAtividade = (atividade) => {
    ...
    <div class="card-bg">
        ${input}
        <div>
            <img src="../assets/circle-check.png" class="active">
            <img src="../assets/circle-dashed.png" class="inactive">
...
const atualizarListaDeAtividades = () => {
    ...
    if(atividades.length == 0) {
        section.innerHTML = `<p class="placeholder-atividades">Nenhuma atividade cadastrada.</p>`
        return
